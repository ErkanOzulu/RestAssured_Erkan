...
public class BookitTestBase {
    ...
    public static void init(){
        baseURI = ConfigurationReader.get("qa3_api_url");
    ...
    public static String getTokenByRole(String role){
        ...
        switch (role) {
            ...
            case "teacher":
                ...
                pass = ConfigurationReader.get("teacher_password");
                break;
            case "student-member":
                email = ConfigurationReader.get("team_member_email");
                pass = ConfigurationReader.get("team_member_password");
                break;

            case "student-leader":
                email = ConfigurationReader.get("team_leader_email");
                pass = ConfigurationReader.get("team_leader_password");
                break;
